...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Full Stack Software Developer 🚀 having an experience of building Web applications with Python / Django / Google Cloud Plateform / JavaScript / Pandas / Matplotlib / Tableau  and other cool libraries and frameworks."
  ),
  resumeLink:
